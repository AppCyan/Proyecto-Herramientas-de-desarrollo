...
public class MenuPrincipal {
    ...
    public static void main(String[] args) {
        // Creo una instancia de la clase ColaClientes para manejar la cola de atención de clientes
        ...
        //// Creo una instancia de la clase PilaMedicamentos para manejar los medicamentos 
...
// Inicio el ciclo do-while para mostrar el menú repetidamente hasta que el usuario decida salir
do {
    ...
    opcion = JOptionPane.showInputDialog(
        ...
        "7. Registrar devolución\n" +    // Opción para registrar una devolución en la pila correspondiente
...
switch (opcion) {
    case "1" -> {
                // Opción 1: Añadir un cliente a la cola

                // Solicito al usuario que ingrese el nombre del cliente
                String nombre = JOptionPane.showInputDialog("Nombre del cliente:");

                // Solicito el DNI del cliente
                String dni = JOptionPane.showInputDialog("DNI:");

                // Solicito el nombre del producto que el cliente desea
                String producto = JOptionPane.showInputDialog("Producto solicitado:");

                // Solicito la edad y la convierto a entero, ya que JOptionPane devuelve texto
                int edad = Integer.parseInt(JOptionPane.showInputDialog("Edad:"));

                // Creo un nuevo objeto Cliente usando los datos que el usuario ingresó
                Cliente c = new Cliente(nombre, dni, producto, edad);

                // Llamo al método encolar para añadir el cliente a la cola
                colaClientes.encolar(c);

                // Muestro un mensaje confirmando que el cliente fue añadido correctamente
    ...
    case "2" -> {
                ...
                if (atendido == null) {
                    // Si no había clientes, muestro un mensaje informando que no hay nadie en la cola
    ...
    case "3" -> {
                ...
                // Llamo al método mostrarCola() para obtener el listado completo de los clientes en la cola
...
case "6" -> {
    ...
    // Llamo al método mostrarPila() para obtener el listado de medicamentos y lo muestro
...
case "8" -> {
    ...
    // Llamo al método mostrarPila() de devoluciones para mostrar todas las devoluciones almacenadas
...
default -> {
    // Caso por defecto: si el usuario ingresó una opción inválida (que no esté entre 1 y 9)
